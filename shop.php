...
<body>
	...
	<?php
			  ...
			  $rs1= mysqli_query($conn, "select * from products");
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".everyday">Everyday Use</li>
			...
			<?php foreach($array as $value):?>
				<div class="col-lg-4 col-md-4 text-center <?=$value['category']?>">
					<div class="single-product-item">
						...
						<h3><?=$value['name']?></h3>
						<p class="product-price"><span></span>₹<?=$value['price']?></p>
